    ...
    <div className="upperS1">
      ...
      <div className="upperS1lower">
        <div>
          ...
          <p>your <span>404</span> and <span>LIFE</span> errors.</p>
        </div>
        <div onClick={featureShow}>
          <img src="/icons/ProductFeaturesN.png" alt="features" />
        </div>
        {stickers.map((sticker) => (
        <div key={sticker.message} className="sticker" style={{top: `${sticker.top}px`, left: sticker.left, transform: `rotate(${sticker.angle}deg)`, backgroundColor: `rgb(${sticker.r},${sticker.g},${sticker.b})`, color: `rgb(${sticker.r2},${sticker.g2},${sticker.b2})`}}>
          {sticker.message}
        </div>
      ))}
      </div>
